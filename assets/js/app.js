...
<a class="navbar-brand" href="index.html">Sheikh Rahmatulla Sakib </a>
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
      ...
      <p class="tag" >As Software Engineers,We don't just write code.We craft elegant solutions that solve real-world problems and empower people to do more with technology.</p>
    </div>
        ...
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 form-comtainer">
          <div class="form-style-6">
             <div class="form-header"> <br> <br> <br>
                <h6 class="display">Get in Touch</h6>
              </div>
                <form name="form1" action="https://formcarry.com/s/BDiz5UM66Q" method="POST" accept-charset="UTF-8" >
    ...
    <a class="social-button linkedin" href="https://www.linkedin.com/in/1kishor0/" target="_blank" >
    ...
    <a class="social-button instagram" href="https://www.instagram.com/kishor.jpeg/?next=%2F" target="_blank" >
    ...
    <a class="social-button github" href="https://github.com/1kishor0" target="_blank">
